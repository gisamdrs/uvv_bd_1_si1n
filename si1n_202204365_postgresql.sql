...
CREATE TABLE hr.empregado_departamento (
                id_departamento INTEGER NOT NULL,
                id_empregados INTEGER NOT NULL,
                CONSTRAINT empregado_departamento_pk PRIMARY KEY (id_departamento, id_empregados)
);
COMMENT ON TABLE hr.empregado_departamento IS 'Tabela intermediária da relação entre empregados e departamentos.';
COMMENT ON COLUMN hr.empregado_departamento.id_departamento IS 'Chave estrangeira para a tabela departamentos.';
COMMENT ON COLUMN hr.empregado_departamento.id_empregados IS 'Chave estrangeira para a tabela empregados.';
...
COMMENT ON TABLE hr.cargos IS 'Tabela cargos, que armazena os cargos existentes e a faixa salarial (mínimo
...
CREATE TABLE hr.historico_cargos (
                ...
                id_cargo VARCHAR(10) NOT NULL,
                id_departamento INTEGER NOT NULL,
                CONSTRAINT hitorico_cargos_pk PRIMARY KEY (data_inicial, id_empregado)
);
...
antiga do empregado.';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'Parte da chave primária composta da tabela.';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'Parte da chave primária composta da tabela.';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'Último dia de um empregado neste cargo.';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'Chave estrangeira para a tabela de departamentos.';
...
COMMENT ON COLUMN hr.empregados.comissao IS 'Porcentagem de comissão de um empregado.';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'Chave estrangeira para a tabela de departamentos.';
COMMENT ON COLUMN hr.empregados.id_cargo IS 'Chave estrangeira para a tabela cargos.';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'Chave estrangeira da própria tabela(auto-relacionamento).';
...
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'Chave estrangeira para a tabela de empregados.';
COMMENT ON COLUMN hr.departamentos.id_gerente IS 'Chave estrangeira para a tabela de localizações.';
...
COMMENT ON COLUMN hr.localizacoes.endereco IS 'logradouro,número de um escritório ou facilidade da empresa.';
COMMENT ON COLUMN hr.localizacoes.cep IS 'CEP da localização de escritório ou facilidade da empresa.';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'Cidade onde está o escritório ou facilidade da empresa.';
COMMENT ON COLUMN hr.localizacoes.uf IS 'Estado onde está o escritório ou facilidade da empresa.';
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'Chave estrangeira para a tabela de países.';


CREATE TABLE hr.id_regioes (
                id_regiao INTEGER NOT NULL,
                nome VARCHAR(25) NOT NULL,
                CONSTRAINT pk_id_regioes PRIMARY KEY (id_regiao)
);
COMMENT ON TABLE hr.id_regioes IS 'Tabela regiões. Contém os números e nomes das regiões.';
COMMENT ON COLUMN hr.id_regioes.id_regiao IS 'Chave primária da tabela regiões.';
COMMENT ON COLUMN hr.id_regioes.nome IS 'Nomes das regiões.';
...
telefone,id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(108, 'Nancy Greenberg', 'NGREENBE', '515.124.4569', 'FI_MGR', 12008, null, 101, 100);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
...
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(150, 'Peter Tucker', 'PTUCKER', '011.44.1344.129268', 'SA_REP', 10000, .3, 145, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(151, 'David Bernstein', 'DBERNSTE', '011.44.1344.345268', 'SA_REP', 9500, .25, 145, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(152, 'Peter Hall', 'PHALL', '011.44.1344.478968', 'SA_REP', 9000, .25, 145, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(153, 'Christopher Olsen', 'COLSEN', '011.44.1344.498718', 'SA_REP', 8000, .2, 145, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(154, 'Nanette Cambrault', 'NCAMBRAU', '011.44.1344.987668',  'SA_REP', 7500, .2, 145, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(155, 'Oliver Tuvault', 'OTUVAULT', '011.44.1344.486508', 'SA_REP', 7000, .15, 145, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
...
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(157, 'Patrick Sully', 'PSULLY', '011.44.1345.929268', 'SA_REP', 9500, .35, 146, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(158, 'Allan McEwen', 'AMCEWEN', '011.44.1345.829268', 'SA_REP', 9000, .35, 146, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(159, 'Lindsey Smith', 'LSMITH', '011.44.1345.729268', 'SA_REP', 8000, .3, 146, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(160, 'Louise Doran', 'LDORAN', '011.44.1345.629268', 'SA_REP', 7500, .3, 146, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(161, 'Sarath Sewall', 'SSEWALL', '011.44.1345.529268', 'SA_REP', 7000, .25, 146, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(162, 'Clara Vishney', 'CVISHNEY', '011.44.1346.129268', 'SA_REP', 10500, .25, 147, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(163, 'Danielle Greene', 'DGREENE', '011.44.1346.229268', 'SA_REP', 9500, .15, 147, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(164, 'Mattea Marvins', 'MMARVINS', '011.44.1346.329268', 'SA_REP', 7200, .1, 147, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(165, 'David Lee', 'DLEE', '011.44.1346.529268', 'SA_REP', 6800, .1, 147, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(166, 'Sundar Ande', 'SANDE', '011.44.1346.629268', 'SA_REP', 6400, .1, 147, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(167, 'Amit Banda', 'ABANDA', '011.44.1346.729268', 'SA_REP', 6200, .1, 147, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(168, 'Lisa Ozer', 'LOZER', '011.44.1343.929268', 'SA_REP', 11500, .25, 148, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
...
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(170, 'Tayler Fox', 'TFOX', '011.44.1343.729268', 'SA_REP', 9600, .2, 148, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(171, 'William Smith', 'WSMITH', '011.44.1343.629268', 'SA_REP', 7400, .15, 148, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(172, 'Elizabeth Bates', 'EBATES', '011.44.1343.529268', 'SA_REP', 7300, .15, 148, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(173, 'Sundita Kumar', 'SKUMAR', '011.44.1343.329268', 'SA_REP', 6100, .1, 148, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(174, 'Ellen Abel', 'EABEL', '011.44.1644.429267', 'SA_REP', 11000, .3, 149, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(175, 'Alyssa Hutton', 'AHUTTON', '011.44.1644.429266', 'SA_REP', 8800, .25, 149, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(176, 'Jonathon Taylor', 'JTAYLOR', '011.44.1644.429265', 'SA_REP', 8600, .2, 149, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(177, 'Jack Livingston', 'JLIVINGS', '011.44.1644.429264', 'SA_REP', 8400, .2, 149, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(178, 'Kimberely Grant', 'KGRANT', '011.44.1644.429263', 'SA_REP', 7000, .15, 149, null);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(179, 'Charles Johnson', 'CJOHNSON', '011.44.1644.429262', 'SA_REP', 6200, .1, 149, 80);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
...
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
(205, 'Shelley Higgins', 'SHIGGINS', '515.123.8080', 'AC_MGR', 12008, null, 101, 110);
INSERT INTO hr.empregados (id_empregado, nome, email,
telefone, id_cargo, salario,
comissao, id_supervisor, id_departamento) VALUES
...
ALTER TABLE hr.empregado_departamento ADD CONSTRAINT empregados_empregado_departamento_fk
...
ALTER TABLE hr.paises ADD CONSTRAINT id_regioes_paises_fk
FOREIGN KEY (id_regiao)
REFERENCES hr.id_regioes (id_regiao)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;


ALTER TABLE hr.empregado_departamento ADD CONSTRAINT departamentos_empregado_departamento_fk
