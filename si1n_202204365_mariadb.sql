...
ALTER TABLE empregado_departamento ADD CONSTRAINT empregados_empregado_departamento_fk
...
ALTER TABLE paises ADD CONSTRAINT id_regioes_paises_fk
FOREIGN KEY (id_regiao)
REFERENCES id_regioes (id_regiao)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
...
ALTER TABLE empregado_departamento ADD CONSTRAINT departamentos_empregado_departamento_fk
